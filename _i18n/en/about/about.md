        ...
        <div class="panel-heading" role="tab" id="heading13">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse13" aria-expanded="false" aria-controls="collapse13">
                    Mobile Developer <small class="text-muted">Aug. 2019 ~ Nov. 2021</small>
                </a>
            </h4>
        </div>
            ...
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    ...
                    <dd>
                        ...
                        <a href="https://www.mindtags.net/en/" target="_blank"><img src="https://www.mindtags.net/images/mt-logo-3.png" alt="MindTags" style="margin-bottom: 10px;"></a>
                    </dd>
                    <dt>Skills:</dt>
                    <dd>Net 4.5+, C#, Xamarin, Android, Realm, Mapbox, Git, GitFlow, GitKraken</dd>
                    <dt>In charge of:</dt>
                    <dd>
                        Development of MindTags Android app that supports disabled people with indoor navigation, beacon, geofence, text-to-speech and GPS.<br />
                    ...
                    <dd>
                        <a href="https://play.google.com/store/apps/details?id=net.mindtags" target="_blank"><img src="https://media.licdn.com/media-proxy/ext?w=512&h=250&f=n&hash=zNRDJU8WlE5HUDHayD3TnylMh3Q%3D&ora=1%2CaFBCTXdkRmpGL2lvQUFBPQ%2CxAVta5g-0R6mm0hUxRMu56KEuFy19kRIS5bZDHS_CHr35Z3CAwWYZKOiPNbe5ypeeXNEyl1md7jVGEWXcezLLIuIHIASi_-jeJHjbgI5Yzc3vzhn5uUQFkEzp6KAA-GgXyxEw8E" alt="MindTags" style="margin-bottom: 10px;"></a>
                    </dd>
                </dl>
            </div>
        </div>
        ...
        <div class="panel-heading" role="tab" id="heading12">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse12" aria-expanded="false" aria-controls="collapse12">
                    Xamarin Developer <small class="text-muted">Jan. 2018 ~ Present</small>
                </a>
            </h4>
        </div>
        ...
        <div class="panel-heading" role="tab" id="heading11">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
                    .Net Developer <small class="text-muted">Jan. 2017 ~ Oct. 2017</small>
                </a>
            </h4>
        </div>
            ...
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    ...
                    <dd>
                        ...
                        <img src="{{ site.baseurl }}/img/portfolio/f21.jpg" alt="Forever21" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
                    ...
                    <dt>In charge of:</dt>
                    <dd>
                        Development and maintenance of stores POS related desktop applications in .Net multi-threaded environment as parts of a supply chain system.<br />
        ...
        <div class="panel-heading" role="tab" id="heading10">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse10" aria-expanded="false" aria-controls="collapse10">
                    Contract Java Developer <small class="text-muted">Sep. 2016 ~ Dec. 2016</small>
                </a>
            </h4>
        </div>
            ...
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    ...
                    <dd>
                        ...
                        <img src="{{ site.baseurl }}/img/portfolio/humeka.jpg" alt="civil service examination application site" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
        ...
        <div class="panel-heading" role="tab" id="heading9">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse9" aria-expanded="false" aria-controls="collapse9">
                    Java Developer <small class="text-muted">Apr. 2016 ~ Jul. 2016</small>
                </a>
            </h4>
        </div>
        <div id="collapse9" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading9">
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    <dt>Location:</dt>
                    <dd>
                        Brainer Consultancy - Queens, NY, USA
                        <img src="{{ site.baseurl }}/img/portfolio/cpfr.gif" alt="CPFR overview" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
        ...
        <div class="panel-heading" role="tab" id="heading8">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse8" aria-expanded="false" aria-controls="collapse8">
                    .Net Developer <small class="text-muted">Aug. 2015 ~ Mar. 2016</small>
                </a>
            </h4>
        </div>
        <div id="collapse8" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading8">
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    <dt>Location:</dt>
                    <dd>
                        Brainer Consultancy - Seoul, South Korea
                        <img src="{{ site.baseurl }}/img/portfolio/hdec.jpg" alt="Hyundai Engineering & Construction" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
                    ...
                    <dt>In charge of:</dt>
                    <dd>Development of ASP.Net webform web application including reports using SmartClient technology and winform in the Hyundai Engineering & Construction company.</dd>
                    <dt>Team size:</dt>
                    <dd>3 members</dd>
                    <dt>Details:</dt>
                    <dd>
        ...
        <div class="panel-heading" role="tab" id="heading7">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false" aria-controls="collapse7">
                    Java and .Net Developer <small class="text-muted">Jan. 2014 ~ Jul. 2015</small>
                </a>
            </h4>
        </div>
        <div id="collapse7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading7">
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    <dt>Location:</dt>
                    <dd>
                        TripleAims - Seoul, South Korea
                        <img src="{{ site.baseurl }}/img/portfolio/keb.jpg" alt="Korean Exchange Bank" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
                    ...
                    <dd>
                        ...
                        such as IBM FileNet and Xtorm at the Korean Exchange Bank.
                    </dd>
                    <dt>Team size:</dt>
                    <dd>4 members</dd>
                    <dt>Details:</dt>
        ...
        <div class="panel-heading" role="tab" id="heading6">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse6" aria-expanded="false" aria-controls="collapse6">
                    Contract .Net Developer <small class="text-muted">Jul. 2013 ~ Dec. 2013</small>
                </a>
            </h4>
        </div>
        <div id="collapse6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6">
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    <dt>Location:</dt>
                    <dd>
                        Devpia - Seoul, South Korea
                        <img src="{{ site.baseurl }}/img/portfolio/hdec.jpg" alt="Hyundai Engineering & Construction" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
                    <dd>ASP.Net, C#, TFS, Javascript, jQuery, Ajax, Json, HTML, CSS, MS-SQL</dd>
                    <dt>In charge of:</dt>
                    <dd>Development of ASP.Net webform web application at Hyundai Engineering & Construction company.</dd>
                    <dt>Team size:</dt>
                    <dd>3 members</dd>
                    <dt>Details:</dt>
                    <dd>
        ...
        <div class="panel-heading" role="tab" id="heading5">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse5" aria-expanded="false" aria-controls="collapse5">
                    Contract .Net and Java Developer <small class="text-muted">Jan. 2013 ~ Jun. 2013</small>
                </a>
            </h4>
        </div>
        <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading5">
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    <dt>Location:</dt>
                    <dd>
                        SoftOne - Seoul, South Korea
                        <img src="{{ site.baseurl }}/img/portfolio/koreanair.jpg" alt="Korean Air" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
                    <dd>ASP.Net, C#, jQuery, Ajax, Java, RAD, SOAP, SoapUI, WebSphere, Oracle</dd>
                    <dt>In charge of:</dt>
                    <dd>Development of ASP.Net webform web application and Java WebService with SOAP at the Korean Air company.</dd>
                    <dt>Team size:</dt>
                    <dd>2 members</dd>
                    <dt>Details:</dt>
                    <dd>
        ...
        <div class="panel-heading" role="tab" id="heading4">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse4" aria-expanded="false" aria-controls="collapse4">
                    Contract Java Developer <small class="text-muted">Oct. 2012 ~ Dec. 2012</small>
                </a>
            </h4>
        </div>
            ...
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    ...
                    <dd>
                        ...
                        <img src="{{ site.baseurl }}/img/portfolio/nia.jpg" alt="National Information Society Agency" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
        ...
        <div class="panel-heading" role="tab" id="heading3">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
                    Contract .Net Developer <small class="text-muted">Apr. 2012 ~ Sep. 2012</small>
                </a>
            </h4>
        </div>
            ...
            <div class="panel-body" style="font-size:0.8em;">
                <dl>
                    ...
                    <dd>
                        ...
                        <img src="{{ site.baseurl }}/img/portfolio/pms.jpg" alt="Portfolio Management System" style="margin-bottom: 10px;">
                    </dd>
                    <dt>Skills:</dt>
            ...
            <div class="panel-heading" role="tab" id="heading2">
                <h4 class="panel-title">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="false" aria-controls="collapse2">
                        Junior .Net and Java Developer <small class="text-muted">Jan. 2011 ~ Mar. 2012</small>
                    </a>
                </h4>
            </div>
            <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
                <div class="panel-body" style="font-size:0.8em;">
                    <dl>
                        <dt>Location:</dt>
                        <dd>
                            Narutech - Seoul, South Korea
                            <img src="{{ site.baseurl }}/img/portfolio/unierp.jpg" alt="uniERP" style="margin-bottom: 10px;">
                        </dd>
                        <dt>Skills:</dt>
        ...
        <div class="panel-heading" role="tab" id="heading1">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="false" aria-controls="collapse1">
                    Junior Software Developer <small class="text-muted">Sep. 2006 ~ Oct. 2010</small>
                </a>
            </h4>
        </div>
        ...
        <div class="panel-heading" role="tab" id="projects-heading1">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion-projects" href="#projects-collapse1" aria-expanded="false" aria-controls="projects-collapse1">
                        Personal Jekyll website project <small class="text-muted">Nov. 2017 ~ Nov. 2017</small>
                </a>
            </h4>
        </div>
